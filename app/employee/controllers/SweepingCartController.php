...
if ((isset($_POST["MM_formRegisterSweepingCart"])) && ($_POST["MM_formRegisterSweepingCart"] == "formRegisterSweepingCart")) {
    ...
    $register = $connection->prepare("INSERT INTO registro_actividades (fecha_inicio, hora_inicio, ciudad, documento, id_estado, fecha_registro) VALUES(:fecha_inicio, :hora_inicio, :ciudad, :documento, :id_estado, :fecha_registro)");
