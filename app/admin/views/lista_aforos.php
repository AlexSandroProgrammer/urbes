                            ...
                            <table id="example"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="custom-table-th">Foto Aforo</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="custom-table-th"><?php echo $aforo['peso']; ?> kg</td>
                                        <td class="custom-table-th">
                                            <?php if (!empty($aforo['foto'])) { ?>
                                            <img src="../../employee/assets/images/<?php echo $aforo['foto']; ?>"
                                                alt="Foto Aforo" class="w-px-100 h-px-100 rounded-circle">
                                            <button class="btn btn-primary mt-2 view-photo-btn"
                                                data-photo="../../employee/assets/images/<?php echo $aforo['foto']; ?>">
