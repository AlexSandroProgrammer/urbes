...
$getLabors = $connection->prepare("SELECT * FROM labores");
$getLabors->execute();
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                if (!empty($_GET["id_labor"])) {
                    ...
                    $queryLabors = $connection->prepare("SELECT * FROM labores WHERE id_labor = :id_labors");
                                        ...
                                        <tr>
                                            <td>
                                                <form method="GET" class="mt-2" action="labores.php">
                                                    <input type="hidden" name="id_labor"
                                                        value="<?= $work['id_labor'] ?>">
