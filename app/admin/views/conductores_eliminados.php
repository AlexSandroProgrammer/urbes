<?php
$titlePage = "Lista Conductores Eliminados";
require_once("../components/sidebar.php");
// arreglo con ids de la consulta
$array_keys = [3, 4];
//*  CONSULTA PARA CONSUMIR LOS DATOS DE LOS CONDUCTORES ELIMINADOS
                                ...
                                <tr>
                                    <td>
                                        <form method="GET" action="">
                                            ...
                                            <input type="hidden" name="ruta" value="conductores_eliminados.php">
