...
$getZones = $connection->prepare("SELECT * FROM zonas");
$getZones->execute();
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                            ...
                            <form class="modal-dialog" action="" method="POST" autocomplete="off"
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel1">Registro de ruta de operacion</h5>
                ...
                if (!empty($_GET["id_zone"])) {
                    ...
                    $queryZone = $connection->prepare("SELECT * FROM zonas WHERE id_zona = :id_zone");
                                            ...
                                            <div class=" mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" minlength="1" maxlength="70" autofocus
                                                        ...
                                                        placeholder="Ingresa el nombre de la ruta"
                                                        value="<?php echo $selectZone['zona']  ?>"
                                                        aria-describedby="zona-2" />
                                                </div>
                                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                <form method="GET" class="mt-2" action="zonas.php">
                                                    <input type="hidden" name="id_zone"
                                                        value="<?= $zone['id_zona'] ?>">
