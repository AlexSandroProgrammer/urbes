<?php
$titlePage = "Lista Empleados Bloqueados";
require_once("../components/sidebar.php");
// arreglo con ids de la consulta
$array_keys = [2, 3];
//*  CONSULTA PARA CONSUMIR LOS DATOS DE LOS EMPLEADOS BLOQUEADOS
...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-4">
            <h2 class="card-header font-bold">Lista Empleados Bloqueados</h2>
            <div class="card-body">
                                ...
                                <tr>
                                    <td>
                                        <form method="GET" action="">
                                            ...
                                            <input type="hidden" name="ruta" value="empleados_bloqueados.php">
