<?php
$titlePage = "Lista Conductores Bloqueados";
require_once("../components/sidebar.php");
// arreglo con ids de la consulta
$array_keys = [2, 4];
//*  CONSULTA PARA CONSUMIR LOS DATOS DE LOS CONDUCTORES BLOQUEADOS
                                ...
                                <tr>
                                    <td>
                                        <form method="GET" action="">
                                            ...
                                            <input type="hidden" name="ruta" value="conductores_bloqueados.php">
