...
if ((isset($_POST["MM_formRegisterLabors"])) && ($_POST["MM_formRegisterLabors"] == "formRegisterLabors")) {
    ...
    if ($queryFetch) {
        ...
        $registerLabors = $connection->prepare("INSERT INTO labores(labor, fecha_registro) VALUES(:labor, :fecha_registro)");
...
if ((isset($_POST["MM_formUpdateLabors"])) && ($_POST["MM_formUpdateLabors"] == "formUpdateLabors")) {
    ...
    if ($queryLabors) {
        ...
        // Inserta los datos en la base de datos
        $updateLabors = $connection->prepare("UPDATE labores SET labor = :labor, fecha_actualizacion = :fecha_actualizacion WHERE id_labor = :id_labor");
